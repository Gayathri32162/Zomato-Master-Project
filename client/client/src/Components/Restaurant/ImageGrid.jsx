...
function ImageGrid(props) {
    return (
        ...
        <div className="w-full h-60 md:hidden">
            <img src={props.images.length && props.images[0]} 
            alt="restaurant" 
        ...
        <div className="hidden w-full h-96 md:flex gap-1">
            ...
            <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden rounded-lg">
                ...
                <img src={props.images.length >=3 && props.images[3]}
                alt="restaurant"
                className="w-full h-full object-cover rounded-lg"
                />
                ...
                <img src={props.images.length >4 && props.images[4]}
                alt="restaurant"
                className="w-full h-full object-cover rounded-lg transform transition duration-700 hover:scale-110"
                />
                <div className="absolute inset-0 bg-opacity-90 bg-gray-400 w-full h-full rounded-lg"/>
                <div className="absolute flex flex-col item-center inset-y-1/4 z-20 w-full h-full text-center text-white font-semibold">
