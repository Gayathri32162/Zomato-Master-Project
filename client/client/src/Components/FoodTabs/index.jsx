            ...
            {allTypes.map((items) => (
                <Link to={`/${items.id}`} className={'w-1/4'}>
                    <div className={
                        ...
                        :"flex flex-col item-center text-xl "
                    }>
                        <div className={type === items.id ? 
                        "w-full flex justify-center items-center flex-col py-3 border-t-2 border-zomato-400"
                              ...
                              <div className={classnames(
                                ...
                                {[`bg-${items.activeColor}-100`]: type === items.id})}>
                                  <img src={
                                    ...
                                    alt="options" className="w-full h-full"
                                    />
                                </div>
